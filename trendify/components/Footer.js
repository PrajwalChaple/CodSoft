        ...
        <div className="footer__grid">
          ...
          <div>
            ...
            <div className="footer__links">
              ...
              <Link href="/" className="footer__link">Shop</Link>
              <Link href="/" className="footer__link">Deals</Link>
              <Link href="/" className="footer__link">What&apos;s New</Link>
          ...
          <div>
            ...
            <div className="footer__links">
              <Link href="#" className="footer__link">Help Center</Link>
              <Link href="#" className="footer__link">Track Order</Link>
              <Link href="#" className="footer__link">Returns & Refunds</Link>
              <Link href="#" className="footer__link">Shipping Info</Link>
          ...
          <div>
            ...
            <div className="footer__newsletter-input">
              <input type="email" placeholder="Enter your email" id="footer-newsletter" />
